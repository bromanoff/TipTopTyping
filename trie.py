...
class Trie:
    ...
    def children(self, prefix: str) -> Iterable[str]:  # returns all children of a prefix in a list
        current = self._root
        ...
        return {current._value: list(current._children.keys())}
        # return list(current._value, current._children.keys())
